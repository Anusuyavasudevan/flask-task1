...
con_string = "mongodb+srv://Anu:MongoAnu@cluster0.srt47hv.mongodb.net/?retryWrites=true&w=majority"

client = pymongo.MongoClient(con_string)

db = client.get_database('empdetails')

user_collection=pymongo.collection.Collection(db,'humanres')
